...
public class BenutzerprofilController {
	 ...
	 * @param benutzerID - ID des aktuell angemeldeten Benutzers
	 * @param mail - E-Mail des aktuell angemeldeten Benutzers
	 * @param aktPW - Aktuelles Passwort des aktuell angemeldeten Benutzers
	 * @param neuesPW - Neues Passwort des aktuell angemeldeten Benutzers
	 * @param wiederholtesPW - Wiederhohlung des neuen Passworts
	 * @return
	 */
	public boolean benutzerprofilAendern(int benutzerID, String mail, String aktPW, String neuesPW, String wiederholtesPW){
		...
		if (benutzer.getPasswort().equals(aktPW)){
			...
			// Wenn neues PW nicht leer ist oder nicht bestätigt wurde ändert nichts
			else {
				return false;
			}
