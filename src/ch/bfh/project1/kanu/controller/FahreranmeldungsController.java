...
public class FahreranmeldungsController {
	...
	/**
	 * Gibt eine Liste zurück, welche alle Fahrer eines Clubs mit den Attributen "Angemeldet", "Vorname", "Nachnahme" und "Jahrgang" enthält, sowie die Auswahlmöglichkeiten
	 * zur Bootsklasse und der Alterskategorie.
	 * @param clubID - ID eines Clubs
	 * @return
	 */
	 ...
	 * @param fahrerID - ID eines Fahrers.
	 */
